...
public class Billing {
	...
	@FindBy(xpath = "(//div[contains(text(),'278.2: Hypervitaminosis A')])[1]")
	...
	@FindBy(xpath = "(//option[@id='billing-fee-schd-icd9_popup'])[1]")
	private WebElement SelectCodeType;
	...
	@FindBy(xpath = "(//div[contains(text(),'E67.0:Hypervitaminosis A')])[1]")
